...
def test_document_import_loads_purchase_context_script():
    ...
    assert '<script src="./static/qr-browser-fallback.js?v=20260921-mapping-management-v7"></script>' in html
    assert '<script src="./static/purchase-context.js?v=20260921-mapping-management-v7"></script>' in html
